...
for i in range(len(listImgFound)-1, -1, -1):
    ...
    if any(key in blockName for key in ("mushroom_block", "bedrock")):
        ...
        tagKeywords = {
            ...
            "decoration": ["sapling","allium","cluster","anvil","azalea","azure","shoot","beacon","roots","bell","leaf","glazed","box","orchid","bookshelf","coral","stand","brown_mushroom","red_mushroom","bush","cactus","sensor","carrots","cauldron","vines","command","chest","flower","plant","eyeblossom","_ore","cocoa","conduit","golem","lantern","torch","craft","fungus","dandelion","pot","dispenser","egg","ghast","dropper","table","fern","frogspawn","lichen","grindstone","core","hopper","ladder","jigsaw","_bud","lectern","lilac","lily","propagule","melon_stem","pumpkin_stem","sprouts","wart_stage","observer","tulip","oxeye","hanging_moss","peony","petals","pitcher","pointed","poppy","comparator","repeater","clump","scaffolding","catalyst","shrieker","vein","pickle","grass","blossom","stonecutter","structure","cane","target","test","tnt","tripwire","wheat","rose"]
        }
